...
wallImage.src = "https://i.postimg.cc/7LwgYqPc/Snowy_Wall.png";
...
floorImage.src = "https://i.postimg.cc/MK86MHR3/Snowy_Floor.png";
...
menuBgImage.src = "https://i.postimg.cc/d3N72TCC/Snowy_Back_Ground.jpg";
...
hatImage.src = 'https://i.postimg.cc/PJ4HrSVn/Christmas-Hat.png';
let hatLoaded = false;
...
function drawBots() {
    bots.forEach(bot=>{
        ...
        if(hatLoaded){
            ...
            ctx.rotate(20*Math.PI/180); // tilt 20 degrees
